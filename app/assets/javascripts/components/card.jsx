                ...
                <div className="device-info">
                    ...
                    <div className = "table-info">
                        <table className = "devise-table">
                            ...
                            <tr><td> <span className = "icon-clock-work"> </span> </td><td>Time work:</td><td> { this.state.plant.per_work } Sec</td><td> </td></tr>
                            <tr><td> <span className = "icon-clock-sleep"> </span> </td><td>Time sleep:</td><td> { this.state.plant.per_sleep/60 } Min</td><td> </td></tr>
                            <tr><td> <span className = "icon-device"> </span> </td><td>Light:</td><td> { this.state.plant.light_start }:00 - { this.state.plant.light_end }:00 </td><td> </td></tr>
